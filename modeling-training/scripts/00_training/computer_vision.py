...
def get_dataloaders(dataset_name, model_name, train_bsz, test_bsz, num_workers=4):
    if dataset_name == 'mnist':
        ...
        train_data = datasets.CIFAR100(
            "../data/cifar100_dataset", train=True, download=True # , transform=transform
        )
        ...
        train_data = datasets.CIFAR100("../data/cifar100_dataset",
                                         train=True,
                                         download=True,
                                         transform=transform_train)
        test_data = datasets.CIFAR100("../data/cifar100_dataset", train=False, transform=transform_test)
